...
## Official Community Plugin Readiness

Before submitting to the Obsidian community plugin gallery:

- Use the plugin-only public repository generated by `npm run export:public-plugin`.
- Keep release tags exactly aligned with `manifest.json` versions.
